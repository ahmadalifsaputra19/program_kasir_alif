          ...
          <div class="auth-form-light text-left p-5">
            ...
            <form class="pt-3" action="/actionlogin" method="post">
              ...
              <div class="mb-2 d-grid gap-2">
                <button type="button" class="btn btn-block btn-facebook auth-form-btn" onclick="connectToFacebook()">
...
<script>
  function connectToFacebook() {
    // Logika untuk menghubungkan dengan Facebook
    alert("Connect to Facebook functionality here.");
  }
</script>